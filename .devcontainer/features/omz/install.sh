...
## Integrate iTerm2 shell integration for Zsh and fix ai agent terminal issues
CODE_TO_APPEND='
  PROMPT_EOL_MARK=""
...
'
curl -sSL https://iterm2.com/shell_integration/zsh -o ~/.iterm2_shell_integration.zsh || true
echo "$CODE_TO_APPEND" >> "$USER_HOME/.zshrc"
